...
В рассматриваемом здесь цикле эти символы отбрасываются до тех пор, пока не достигается конец строки. Если не сделать этого, лишние символы бу­дут передаваться программе в качестве выбранной буквы, что не соответствует действительности. (Для того чтобы убедиться в этом, попробуйте закомменти­ровать внутренний цикл do-while в исходном коде программы.)
*/ 
